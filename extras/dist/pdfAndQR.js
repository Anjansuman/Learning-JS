...
function generateQRCode(data) {
    return __awaiter(this, void 0, void 0, function* () {
        return new Promise((resolve, reject) => {
            qrcode_1.default.toDataURL(data, { errorCorrectionLevel: 'H' }, (err, url) => {
                if (err)
                    reject(err);
                resolve(url);
            });
...
function generateCertificate(name, course, date) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const titleFont = yield pdfDoc.embedFont(pdf_lib_1.StandardFonts.HelveticaBold);
        const contentFont = yield pdfDoc.embedFont(pdf_lib_1.StandardFonts.Helvetica);
        const fontSize = 18;
        ...
        const qrCodeUrl = yield generateQRCode(qrData);
        // Embed the QR code image into the PDF
        const qrImage = yield pdfDoc.embedPng(qrCodeUrl);
        ...
        fs_1.default.writeFileSync('certificate_with_qr.pdf', pdfBytes);
